...
import xpfei.myapp.db.HMROpenHelper;
import xpfei.myapp.model.DaoMaster;
import xpfei.myapp.model.DaoSession;
import xpfei.mylibrary.db.IDatabase;
...
public abstract class AbstractDatabaseManager<M, K> implements IDatabase<M, K> {
    private static final String DEFAULT_DATABASE_NAME = "Cssd.db";
    /**
     ...
     */
    private static DaoMaster.OpenHelper getOpenHelper(@NonNull Context context, @Nullable String dataBaseName) {
        closeDbConnections();
        return new HMROpenHelper(context, dataBaseName, null);
    }
    ...
    public static void UpdateDb() {
        mHelper.onUpgrade(daoSession.getDatabase(), 1, 2);
    }

...
public class BackgourndAnimationLinerLayout extends LinearLayout {
    ...
    public BackgourndAnimationLinerLayout(Context context) {
        this(context, null);
    }

    public BackgourndAnimationLinerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BackgourndAnimationLinerLayout(Context context, AttributeSet attrs, int
            defStyleAttr) {
    ...
    private void initObjectAnimator() {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                BackgourndAnimationLinerLayout.this.setBackground(layerDrawable);
            }
        });

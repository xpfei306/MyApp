...
import xpfei.mylibrary.utils.AESTools;

public class BaiduMusicApi {

    private static final String BASE = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json";

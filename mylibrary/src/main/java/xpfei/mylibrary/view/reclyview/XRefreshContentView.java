...
import xpfei.mylibrary.view.reclyview.listener.OnBottomLoadMoreTime;
import xpfei.mylibrary.view.reclyview.listener.OnTopRefreshTime;
import xpfei.mylibrary.view.reclyview.recyclerview.BaseRecyclerAdapter;
import xpfei.mylibrary.view.reclyview.recyclerview.XSpanSizeLookup;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime, OnBottomLoadMoreTime {
    ...
    private boolean mHasLoadComplete = false;//当已无更多数据时候，需把这个变量设为true
    ...
    private int mPreLoadCount;//静默加载时提前加载的item个数
    ...
    void setContentViewLayoutParams(boolean isHeightMatchParent, boolean isWidthMatchParent) {
    ...
    private void onRecyclerViewScrolled(RecyclerView recyclerView, BaseRecyclerAdapter adapter, int dx, int dy, boolean force) {
    ...
    private void doSilenceLoadMore() {
    ...
    public void startLoadMore(boolean silence) {

...
import xpfei.mylibrary.view.pulltorefresh.internal.FlipLoadingLayout;
...
import xpfei.mylibrary.view.pulltorefresh.internal.RotateLoadingLayout;
import xpfei.mylibrary.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    private OnRefreshListener3<T> mOnRefreshListener3;
    ...
    public final void setOnRefreshListener(OnRefreshListener3<T> listener) {
//        mOnRefreshListener2 = null;
//        mOnRefreshListener = null;
    ...
    protected void onReset() {
        ...
        // 回调取消状态
        if (null != mOnRefreshListener3) {
            mOnRefreshListener3.onCancelRefresh(this);
        }
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
            mScrollingWhileRefreshingEnabled = a
                    .getBoolean(R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled,
                            false);
        }
    ...
    public interface OnPullEventListener<V extends View> {
         ...
         */
        void onPullEvent(final PullToRefreshBase<V> refreshView,
    ...
    public interface OnRefreshListener3<V extends View> {
        /**
         * 取消状态
         *
         * @param refreshView
         */
        void onCancelRefresh(final PullToRefreshBase<V> refreshView);
    }

 ...
 *******************************************************************************/
package xpfei.mylibrary.view.pulltorefresh.internal;
...
import xpfei.mylibrary.view.pulltorefresh.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public final void hideAllViews() {
		...
		if (View.VISIBLE == logoImage.getVisibility()) {
	...
	public final void showInvisibleViews() {
		...
		if (View.INVISIBLE == logoImage.getVisibility()) {
	...
	public void setmInnerLayout(int id){
		if (null!=mInnerLayout){
			mInnerLayout.setBackgroundColor(getResources().getColor(id));
		}
